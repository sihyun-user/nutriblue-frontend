...
export default function SideNavigation({ isNavOpen }: Props) {
  ...
  return (
    <nav
      className={`${isNavOpen ? 'w-64 translate-x-0' : 'translate-x-64'} fixed left-0 top-0 z-30 min-h-screen overflow-hidden border-r border-r-blue-200 bg-primary-50 transition-all duration-300 md:w-16 md:hover:w-64`}
    >
